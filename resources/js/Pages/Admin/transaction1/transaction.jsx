      ...
      <div className="p-4">
        ...
        {transaction && (
          <div className="mb-4">
            ...
            <div className="bg-gray-100 p-4 rounded">
              ...
              <p><strong>Status:</strong> {transaction.txn_status === 1 ? "Success" : "Failed"}</p>
              <p><strong>Amount:</strong> ₹{transaction.txn_amount}</p>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block font-semibold">State Response</label>
              <input
                type="text"
                name="stateresp"
