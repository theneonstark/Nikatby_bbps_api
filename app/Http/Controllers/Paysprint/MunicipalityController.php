...
class MunicipalityController
{
    ...
    public function MunicipalityOperator()
    {
        ...
        return Inertia::render('Municipality/MunicipalityOperator', [
            'municipalities' => $municipalities
        ]);
    }
    public function fetchMunicipalityOperator(Request $request)
    {
        ...
        ])->post('https://uat.nikatby.in/forwarding/public/api/utility/Municipality/fetchMunicipalityOperator', [
            'mode' => $mode
        ]);
    ...
    {
        return Inertia::render('Municipality/FetchMunicipalityDetails');
    }
    ...
    public function fetchBillDetails(Request $request)
    {
        try {
            ...
            ])->post('https://uat.nikatby.in/forwarding/public/api/utility/Municipality/fetchBillDetails', [
    ...
    {
        return Inertia::render('Municipality/MunicipalityBill');
    }
    ...
    public function PayMunicipalityBill(Request $request)
      {
        ...
        $response = Http::withHeaders([
            ...
            // 'accept' => 'application/json',
            // 'Authorisedkey' => 'Y2RkZTc2ZmNjODgxODljMjkyN2ViOTlhM2FiZmYyM2I='
        ])->post('https://uat.nikatby.in/forwarding/public/api/utility/Municipality/PayMunicipalityBill', $validatedData);
    ...
    {
        return Inertia::render('Municipality/MunicipalityStatus');
    }
    ...
    public function MunicipalityEnquiryStatus(Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            // 'accept' => 'application/json',
            // 'Authorisedkey' => 'Y2RkZTc2ZmNjODgxODljMjkyN2ViOTlhM2FiZmYyM2I='
        ])->post('https://uat.nikatby.in/forwarding/public/api/utility/Municipality/MunicipalityEnquiryStatus', [
